...
#TODO:Refactor this code. Divide with comments which url is for shred and
#which is not.
urlpatterns = patterns('',
        ...
        url(r'^shared/(?P<filename>.+)/comment$', views.shared_comment),
        url(r'^shared/(?P<filename>.+)$', views.shared, name='analysis_shared_page'),
        url(r'^(?P<filename>.+)/comment$', views.comment),
